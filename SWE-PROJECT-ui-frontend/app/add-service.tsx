...
export default function AddServiceScreen() {
  ...
  const { vehicles, addService } = useAppData();

  const vehicleNames = vehicles.map((vehicle) => vehicle.name);

  const [selectedVehicle, setSelectedVehicle] = useState(vehicleNames[0] || '');
  ...
  const [date, setDate] = useState('04/06/2026');
  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.sheet}>
        ...
        >
          <Text style={styles.title}>Log Maintenance Record</Text>
          ...
          <Text style={styles.helperText}>
            Mileage should be greater than the last recorded service mileage.
          </Text>
